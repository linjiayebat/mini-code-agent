...
- [ ] **Step 3: Implement the minimal settings fields**
...
- [ ] **Step 3: Implement provider and tool composition**
...
- [ ] **Step 4: Add and verify the async task runner tests**
...
- [ ] **Step 1: Write failing approval and event rendering tests**
...
- [ ] **Step 3: Implement bounded Rich terminal rendering**
...
- [ ] **Step 2: Verify the run tests fail**
...
- [ ] **Step 7: Verify all CLI tests pass**
...
- [ ] **Step 1: Document SiliconFlow configuration**
