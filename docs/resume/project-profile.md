...
> 联调尚未实现。`v0.12.0-alpha.0` GitHub prerelease 已发布；M5a 本地双 Python、90.86%
> 分支覆盖率、安全审计和四组制品 smoke 已通过，v0.13 远程 CI/Release 证据待回填。
